...
|Ack no.|No ack no.|
|Overhead is high(20-60Byte)|overhead is less(8 Byte)|
...
> This is my domain name, tell me my IP address

> Why SMTP protocol used for Email is not UDP? 
...
> Suppose you send a file greater than 20 MB. Suppose we send by pieces, then what is the guarantee in UDP it will get sent in the order.